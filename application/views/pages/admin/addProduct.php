    <input type="checkbox" id="presco-navigation" hidden>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul>
                                    <li class="text-start"><a href="#!" class="dropdown-item">Manage Sale</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <li class="presco-nav-header">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul>
                                    <li class="text-start"><a href="<?php echo base_url();?>admin/addProduct" class="dropdown-item">Manage Product</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <li class="presco-nav-header">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul>
                                    <li class="text-start"><a href="#!" class="dropdown-item">Add Customer</a></li>
                                    <li class="text-start"><a href="#!" class="dropdown-item">Manage Customer</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-lg-10 main-content">
        <div class="row gy-3 p-3">
            <div class="col-lg-12">
                <h2 class="text-primary fw-bold">Product</h2>
            </div>
            <div class="col-lg-12">
