        ...
        <div class="col-lg-9">
            <div class="row">
                ...
                <div class="col-lg-12 p-3 table-responsive" id="table-container">
                    <table id="trackingTable" class="table text-center">
                ...
                if (res.response.length != 0) {
                    ...
                    trackinginfo.forEach(info => {
                        ...
                        info.products.forEach(product => {
                            productColumn += `<li class="d-flex flex-column align-items-center" style="max-width: 300px"><div class="order-product-list-img"><img src="${base_url + product.product_image}"/></div><p class="mx-3 order-product-list-name">${product.product_name} x ${product.quantity}</p></li>`;
                        });
                        ...
                        $("#trackingTable").DataTable().clear().destroy();
